...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const getNavItems = () => {
    if (user.role === 'patient') {
      return [
        { href: '/patient', label: 'Dashboard', icon: <BarChart3 className="h-5 w-5" /> },
        { href: '/patient/health', label: 'Health Tracking', icon: <Activity className="h-5 w-5" /> },
        { href: '/patient/appointments', label: 'Appointments', icon: <CalendarDays className="h-5 w-5" /> },
      ...
      return [
        { href: '/hospital', label: 'Dashboard', icon: <BarChart3 className="h-5 w-5" /> },
        { href: '/hospital/doctors', label: 'Doctors', icon: <Stethoscope className="h-5 w-5" /> },
