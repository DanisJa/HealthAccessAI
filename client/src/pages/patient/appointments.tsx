...
export default function PatientAppointments() {
  ...
  const { data: appointments, isLoading: isAppointmentsLoading } = useQuery({
    queryKey: ['/api/patient/appointments', tab, date ? format(date, 'yyyy-MM-dd') : null],
  });
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                  <Tabs defaultValue="upcoming" onValueChange={setTab} className="w-full sm:w-auto">
                          ...
                          <div key={appointment.id} className="flex p-3 border border-neutral-200 rounded-lg hover:bg-neutral-50">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-sm text-neutral-600">
                                Dr. {appointment.doctor.firstName} {appointment.doctor.lastName} - {appointment.title}
                              </p>
