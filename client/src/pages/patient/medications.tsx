...
import { Search, RefreshCw, Pill, FileClock, AlertTriangle } from "lucide-react";
            ...
            <div className="py-4">
              <div className="flex items-center space-x-3 mb-6">
                <Avatar>
                  ...
                  <AvatarFallback>
                    {getInitials(selectedMedication.doctor.firstName, selectedMedication.doctor.lastName)}
                  </AvatarFallback>
                </Avatar>
                <div>
                  <p className="font-medium">Prescribed by: Dr. {selectedMedication.doctor.firstName} {selectedMedication.doctor.lastName}</p>
                  <p className="text-sm text-muted-foreground">
                    {format(new Date(selectedMedication.startDate), 'MMMM d, yyyy')}
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-medium">
                    {selectedMedication.endDate ? 
                      format(new Date(selectedMedication.endDate), 'MMMM d, yyyy') : 
                      'Ongoing'}
                  </p>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-100 rounded-md p-4 mt-6 flex">
                ...
                <div className="text-sm text-yellow-700">
                  ...
                  <ul className="list-disc pl-5 mt-1 space-y-1">
                    ...
                    <li>Do not skip doses or stop taking without consulting your doctor.</li>
